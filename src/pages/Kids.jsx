...
const Kids = () => {
  ...
  const kidProducts = products.filter((product) => (product.category == 'kid'
  ))

  return (
    <>
      <div className='max-w-screen-2xl w-full md:w-[95%] container md:px-10 px-2 mx-auto py-8'>
        <div style={{ backgroundImage: `url(${kid})`, backgroundPosition: "Top" }} className='bg-cover bg-enter h-[550px] relative'>
          ...
          <div className='absolute flex md:justify-start  items-center justify-center md:px-8  inset-0'>
            <div className='flex gap-4 flex-col  justify-center items-center text-white'>
              <p className='text-2xl md:text-3xl font-extrabold '> Latest for kids 50% off</p>
        ...
        <div className='md:pt-20 pt-10'>
          <h1 className='font-extrabold text-2xl md:text-3xl'>Kid's Collections</h1>
          <div className='grid grid-cols-1 gap-8 mt-6  mx-4 md:grid-cols-3'>
            {kidProducts.map((products) => (
